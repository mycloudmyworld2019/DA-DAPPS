...
mkdir -p ${PROJECT}/${VERSION}/opt/DA-DAPPSio/lib/cmake
...
echo "class DA-DAPPSio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/DA-DAPPSio/DA-DAPPS/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/DA-DAPPSio/DA-DAPPS/releases/download/v${VERSION}\"
