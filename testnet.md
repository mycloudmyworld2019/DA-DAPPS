...
Before getting into the details of the DA-DAPPS testnet, lets clarify some terms. In this document I use the terms "host" and "machine" fairly interchangeably. A host generally boils down to a single IP address, although in practice it could have more.
...
#### Star network
![](https://github.com/DA-DAPPSio/DA-DAPPS/raw/master/star.png)
...
#### Mesh network
![](https://github.com/DA-DAPPSio/DA-DAPPS/raw/master/mesh.png)
...
```
  "nodes": [[
      "testnet_0",{
        ...
        "ssh_identity": "",
        "ssh_args": "",
        "eos_root_dir": "/home/phil/blockchain/DA-DAPPS",
        "data_dir": "tn_data_0",
        "hostname": "remoteserv",
...
It is also necessary to provision the server by at least copying the eosd executable, and the genesis.json files to their appropriate locations relative to some named DA-DAPPS root directory. For example, I defined the DA-DAPPS root to be `/home/phil/blockchain/DA-DAPPS`. When run, the launcher will run through a variety of shell commands using ssh and finally using scp to copy a config.ini file to the appropriate data directory on the remote.
