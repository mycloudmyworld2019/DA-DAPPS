...
#include <DA-DAPPSio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::global_property_object, DA-DAPPSio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::dynamic_global_property_object,
                         DA-DAPPSio::chain::dynamic_global_property_multi_index)

FC_REFLECT(DA-DAPPSio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(DA-DAPPSio::chain::global_property_object,
