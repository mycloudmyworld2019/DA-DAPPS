...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::transaction_object, DA-DAPPSio::chain::transaction_multi_index)

FC_REFLECT(DA-DAPPSio::chain::transaction_object, (expiration)(trx_id))
