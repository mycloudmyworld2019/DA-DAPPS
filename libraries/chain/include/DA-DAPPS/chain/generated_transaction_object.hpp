...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::generated_transaction_object, DA-DAPPSio::chain::generated_transaction_multi_index)

FC_REFLECT(DA-DAPPSio::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
