...
FC_REFLECT( DA-DAPPSio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( DA-DAPPSio::chain::base_action_trace,
                    (receipt)(act)(context_free)(elapsed)(console)(trx_id)
                    (block_num)(block_time)(producer_block_id)(account_ram_deltas)(except) )

FC_REFLECT_DERIVED( DA-DAPPSio::chain::action_trace,
                    (DA-DAPPSio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( DA-DAPPSio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
