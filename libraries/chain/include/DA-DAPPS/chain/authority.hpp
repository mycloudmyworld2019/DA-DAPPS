...
FC_REFLECT(DA-DAPPSio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(DA-DAPPSio::chain::key_weight, (key)(weight) )
FC_REFLECT(DA-DAPPSio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(DA-DAPPSio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(DA-DAPPSio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
