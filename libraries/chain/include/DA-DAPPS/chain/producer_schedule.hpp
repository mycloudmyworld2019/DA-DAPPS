...
FC_REFLECT( DA-DAPPSio::chain::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( DA-DAPPSio::chain::producer_schedule_type, (version)(producers) )
FC_REFLECT( DA-DAPPSio::chain::shared_producer_schedule_type, (version)(producers) )
