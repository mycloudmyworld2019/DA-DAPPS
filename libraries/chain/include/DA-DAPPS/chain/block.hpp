#pragma once
#include <DA-DAPPSio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( DA-DAPPSio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(DA-DAPPSio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(DA-DAPPSio::chain::transaction_receipt, (DA-DAPPSio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(DA-DAPPSio::chain::signed_block, (DA-DAPPSio::chain::signed_block_header), (transactions)(block_extensions) )
