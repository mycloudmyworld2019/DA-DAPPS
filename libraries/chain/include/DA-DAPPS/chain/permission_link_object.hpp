...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::permission_link_object, DA-DAPPSio::chain::permission_link_index)

FC_REFLECT(DA-DAPPSio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
