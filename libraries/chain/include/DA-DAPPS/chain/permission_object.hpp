...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::permission_object, DA-DAPPSio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::permission_usage_object, DA-DAPPSio::chain::permission_usage_index)

FC_REFLECT(DA-DAPPSio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(DA-DAPPSio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(DA-DAPPSio::chain::permission_usage_object, (last_used))
