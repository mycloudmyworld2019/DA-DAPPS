...
#include <DA-DAPPSio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::table_id_object, DA-DAPPSio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::key_value_object, DA-DAPPSio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::index64_object, DA-DAPPSio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::index128_object, DA-DAPPSio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::index256_object, DA-DAPPSio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::index_double_object, DA-DAPPSio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::index_long_double_object, DA-DAPPSio::chain::index_long_double_index)

FC_REFLECT(DA-DAPPSio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(DA-DAPPSio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(DA-DAPPSio::chain::index64_object)
REFLECT_SECONDARY(DA-DAPPSio::chain::index128_object)
REFLECT_SECONDARY(DA-DAPPSio::chain::index256_object)
REFLECT_SECONDARY(DA-DAPPSio::chain::index_double_object)
REFLECT_SECONDARY(DA-DAPPSio::chain::index_long_double_object)
