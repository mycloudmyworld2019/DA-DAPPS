...
CHAINBASE_SET_INDEX_TYPE(DA-DAPPSio::chain::block_summary_object, DA-DAPPSio::chain::block_summary_multi_index)

FC_REFLECT( DA-DAPPSio::chain::block_summary_object, (block_id) )
