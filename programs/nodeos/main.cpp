...
{
   try {
      app().set_version(DA-DAPPSio::nodeos::config::version);

      auto root = fc::app_path();
      app().set_default_data_dir(root / "DA-DAPPSio/nodeos/data" );
      app().set_default_config_dir(root / "DA-DAPPSio/nodeos/config" );
      ...
      ilog("DA-DAPPSio root is ${root}", ("root", root.string()));
