...
void test_print::test_printn() {
   printn(DA-DAPPSio::name{"1"}.value);
   printn(DA-DAPPSio::name{"5"}.value);
   printn(DA-DAPPSio::name{"a"}.value);
   printn(DA-DAPPSio::name{"z"}.value);

   printn(DA-DAPPSio::name{"abc"}.value);
   printn(DA-DAPPSio::name{"123"}.value);

   printn(DA-DAPPSio::name{"abc.123"}.value);
   printn(DA-DAPPSio::name{"123.abc"}.value);

   printn(DA-DAPPSio::name{"12345abcdefgj"}.value);
   printn(DA-DAPPSio::name{"ijklmnopqrstj"}.value);
   printn(DA-DAPPSio::name{"vwxyz.12345aj"}.value);

   printn(DA-DAPPSio::name{"111111111111j"}.value);
   printn(DA-DAPPSio::name{"555555555555j"}.value);
   printn(DA-DAPPSio::name{"aaaaaaaaaaaaj"}.value);
   printn(DA-DAPPSio::name{"zzzzzzzzzzzzj"}.value);
}
...
void test_print::test_print_simple() {
    ...
    DA-DAPPSio::print(cvalue);
    std::string value = "value";
    DA-DAPPSio::print(std::move(value));
}
