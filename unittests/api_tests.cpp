...
bool is_access_violation(fc::unhandled_exception const & e) {
   try {
    ...
    catch (const DA-DAPPSio::chain::wasm_execution_error& e) {
       return true;
    } catch (...) {
...
bool is_wasm_execution_error(DA-DAPPSio::chain::wasm_execution_error const& e) {return true;}
...
BOOST_FIXTURE_TEST_CASE(action_tests, TESTER) { try {
   ...
   BOOST_CHECK_EXCEPTION(CALL_TEST_FUNCTION( *this, "test_action", "read_action_to_0", raw_bytes), DA-DAPPSio::chain::wasm_execution_error,
         [](const DA-DAPPSio::chain::wasm_execution_error& e) {
   ...
   // test read_action_to_64k
   raw_bytes.resize(3);
	BOOST_CHECK_EXCEPTION(CALL_TEST_FUNCTION( *this, "test_action", "read_action_to_64k", raw_bytes ), DA-DAPPSio::chain::wasm_execution_error,
         [](const DA-DAPPSio::chain::wasm_execution_error& e) {
            return expect_assert_message(e, "access violation");
         }
      );
...
BOOST_FIXTURE_TEST_CASE(transaction_tests, TESTER) { try {
   ...
   BOOST_CHECK_EXCEPTION(CALL_TEST_FUNCTION(*this, "test_transaction", "send_action_recurse", {}), DA-DAPPSio::chain::transaction_exception,
         [](const DA-DAPPSio::chain::transaction_exception& e) {
...
#warning re-enable deferred transaction replacement test after bug has been fixed
...

   {
      ...
      // But not anymore. Now it should subjectively fail because testapi@additional permission is not unilaterally satisfied by testapi@DA-DAPPSio.code.
      dtt_action dtt_act3;
