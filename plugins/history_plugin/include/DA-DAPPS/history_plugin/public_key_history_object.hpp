...
CHAINBASE_SET_INDEX_TYPE( DA-DAPPSio::public_key_history_object, DA-DAPPSio::public_key_history_multi_index )

FC_REFLECT( DA-DAPPSio::public_key_history_object, (public_key)(name)(permission) )
