...
CHAINBASE_SET_INDEX_TYPE( DA-DAPPSio::account_control_history_object, DA-DAPPSio::account_control_history_multi_index )

FC_REFLECT( DA-DAPPSio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
