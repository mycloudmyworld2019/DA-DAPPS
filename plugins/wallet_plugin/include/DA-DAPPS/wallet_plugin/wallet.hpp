...
#include <DA-DAPPSio/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key DA-DAPPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( DA-DAPPSio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( DA-DAPPSio::wallet::plain_keys, (checksum)(keys) )
