 ...
 */
#include <DA-DAPPSio/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(DA-DAPPSio::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     DA-DAPPSio::detail::producer_api_plugin_response result{"ok"};
