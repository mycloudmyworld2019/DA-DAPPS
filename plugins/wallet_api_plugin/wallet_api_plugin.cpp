 ...
 */
#include <DA-DAPPSio/wallet_api_plugin/wallet_api_plugin.hpp>
...
FC_REFLECT(DA-DAPPSio::detail::wallet_api_plugin_empty, );
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     DA-DAPPSio::detail::wallet_api_plugin_empty result;
