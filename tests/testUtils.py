...
class Utils:
    ...
    DA-DAPPSClientPath="programs/cleos/cleos"
    MiscDA-DAPPSClientArgs="--no-auto-keosd"

    DA-DAPPSWalletName="keosd"
    DA-DAPPSWalletPath="programs/keosd/"+ EosWalletName

    DA-DAPPSServerName="nodeos"
    DA-DAPPSServerPath="programs/nodeos/"+ DA-DAPPSServerName

    DA-DAPPSLauncherPath="programs/DA-DAPPSio-launcher/DA-DAPPSio-launcher"
    MongoPath="mongo"
    ShuttingDown=False
    CheckOutputDeque=deque(maxlen=10)

    DA-DAPPSBlockLogPath="programs/DA-DAPPSio-blocklog/DA-DAPPSio-blocklog"
    ...
    def getBlockLog(blockLogLocation, silentErrors=False, exitOnError=False):
        ...
        cmd="%s --blocks-dir %s --as-json-array" % (Utils.DA-DAPPSBlockLogPath, blockLogLocation)
