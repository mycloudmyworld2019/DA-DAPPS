...
class StressNetwork:
    ...
    def execute(self, cmdInd, node, ta, DA-DAPPSio):
        ...
        tr = node.createAccount(ta, DA-DAPPSio, stakedDeposit=0, waitForTransBlock=True, exitOnError=True)
        ...
        opts="--permission DA-DAPPSio@active"
