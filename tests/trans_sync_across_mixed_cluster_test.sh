...
echo Launcher options: --nodeos \"--plugin DA-DAPPSio::wallet_api_plugin\" $launcherOpts
programs/DA-DAPPSio-launcher/DA-DAPPSio-launcher --nodeos "--plugin DA-DAPPSio::wallet_api_plugin" $launcherOpts
sleep 7
