...
class Node(object):
    ...
    def __init__(self, host, port, pid=None, cmd=None, walletMgr=None, enableMongo=False, mongoHost="localhost", mongoPort=27017, mongoDb="DADAPPStest"):
        self.host=host
        self.port=port
        self.pid=pid
        self.cmd=cmd
    ...
    def getAccountEosBalanceStr(self, scope):
        ...
        assert isinstance(scope, str)
        amount=self.getTableAccountBalance("DA-DAPPSio.token", scope)
