...
//extern uint32_t DADAPPS_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("DADAPPS_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      DADAPPS_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "DADAPPS_TESTING_GENESIS_TIMESTAMP is " << DADAPPS_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
